    ...
    try {
      ...
      if(memberguild.id=="257889450850254848"){
        setTimeout(_ =>{
          ...
          let welcomeC=memberguild.channels.find('name','unverified')||client.channels.get("307342989783728131");
        ...
        setTimeout(_ => {
          ...
          let welcomeC=memberguild.channels.find('name','unverified')||client.channels.get("308772937731670016");

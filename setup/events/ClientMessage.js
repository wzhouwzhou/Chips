...
module.exports = function() {
  ...
  client.on("message", async message => {
    ...
    if (message.guild.id==Constants.servers.SINX&&message.author.id=='304322292769488906'&&(/^[^]*(commandnotfound)[^]*$/).test(message.content.toLowerCase().replace(/\s+/g,''))) return await message.delete(); 

...
(function($) {
  function Plot(placeholder, data_, options_, plugins) {
    ...
    function setupGrid() {
      ...
      allocatedAxes = $.grep(axes, axis => axis.reserveSpace);
    ...
    function drawBarHighlight(series, point) {
      ...
      drawBar(point[0], point[1], point[2] || 0, barLeft, barLeft + series.bars.barWidth,
        0, () => fillStyle, series.xaxis, series.yaxis, octx, series.bars.horizontal, series.bars.lineWidth);
    }
